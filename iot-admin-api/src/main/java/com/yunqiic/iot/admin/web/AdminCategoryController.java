...
import com.yunqiic.iot.admin.vo.CategoryVo;
import com.yunqiic.iot.core.util.ResponseUtil;
import com.yunqiic.iot.db.domain.IotCategory;
import com.yunqiic.iot.db.service.IotCategoryService;
...
public class AdminCategoryController {
    ...
    public Object list() {
        ...
        List<IotCategory> categoryList = categoryService.queryByPid(0);
        for (IotCategory category : categoryList) {
            ...
            List<IotCategory> subCategoryList = categoryService.queryByPid(category.getId());
            for (IotCategory subCategory : subCategoryList) {
    ...
    private Object validate(IotCategory category) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody IotCategory category) {
    ...
    public Object read(@NotNull Integer id) {
        IotCategory category = categoryService.findById(id);
        return ResponseUtil.ok(category);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody IotCategory category) {
        Object error = validate(category);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody IotCategory category) {
    ...
    public Object catL1() {
        ...
        for (IotCategory category : l1CatList) {
