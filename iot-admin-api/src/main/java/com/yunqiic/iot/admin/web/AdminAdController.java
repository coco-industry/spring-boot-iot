...
import com.yunqiic.iot.db.service.IotAdService;
...
public class AdminAdController {
    ...
    public Object list(String name, String content,
        ...
        List<IotAd> adList = adService.querySelective(name, content, page, limit, sort, order);
        return ResponseUtil.okList(adList);
    }

    private Object validate(IotAd ad) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody IotAd ad) {
    ...
    public Object read(@NotNull Integer id) {
        IotAd ad = adService.findById(id);
        return ResponseUtil.ok(ad);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody IotAd ad) {
        Object error = validate(ad);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody IotAd ad) {
        Integer id = ad.getId();
        if (id == null) {
            return ResponseUtil.badArgument();
        }
