...
import static com.yunqiic.iot.admin.util.AdminResponseCode.ROLE_NAME_EXIST;
import static com.yunqiic.iot.admin.util.AdminResponseCode.ROLE_USER_EXIST;
...
public class AdminRoleController {
    ...
    public Object list(String name,
        ...
        List<IotRole> roleList = roleService.querySelective(name, page, limit, sort, order);
        return ResponseUtil.okList(roleList);
    }

    @GetMapping("/options")
    public Object options() {
        List<IotRole> roleList = roleService.queryAll();
    ...
    public Object read(@NotNull Integer id) {
        IotRole role = roleService.findById(id);
        return ResponseUtil.ok(role);
    }


    private Object validate(IotRole role) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody IotRole role) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody IotRole role) {
        Object error = validate(role);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody IotRole role) {
    ...
    public Object updatePermissions(@RequestBody String body) {
        ...
        for (String permission : permissions) {
            IotPermission iotPermission = new IotPermission();
            iotPermission.setRoleId(roleId);
            iotPermission.setPermission(permission);
            permissionService.add(iotPermission);
        }
        return ResponseUtil.ok();
    }
