...
public class AdminKeywordController {
    ...
    @Autowired
    private IotKeywordService keywordService;
    ...
    public Object list(String keyword, String url,
        ...
        List<IotKeyword> keywordList = keywordService.querySelective(keyword, url, page, limit, sort, order);
        return ResponseUtil.okList(keywordList);
    }

    private Object validate(IotKeyword keywords) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody IotKeyword keyword) {
    ...
    public Object read(@NotNull Integer id) {
        IotKeyword keyword = keywordService.findById(id);
        return ResponseUtil.ok(keyword);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody IotKeyword keyword) {
        Object error = validate(keyword);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody IotKeyword keyword) {
