...
public class AdminIssueController {
    ...
    public Object list(String question,
        ...
        List<IotIssue> issueList = issueService.querySelective(question, page, limit, sort, order);
        return ResponseUtil.okList(issueList);
    }

    private Object validate(IotIssue issue) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody IotIssue issue) {
    ...
    public Object read(@NotNull Integer id) {
        IotIssue issue = issueService.findById(id);
        return ResponseUtil.ok(issue);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody IotIssue issue) {
        Object error = validate(issue);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody IotIssue issue) {
