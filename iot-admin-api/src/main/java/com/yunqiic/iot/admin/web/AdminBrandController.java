...
import com.yunqiic.iot.db.service.IotBrandService;
...
public class AdminBrandController {
    ...
    public Object list(String id, String name,
        ...
        List<IotBrand> brandList = brandService.querySelective(id, name, page, limit, sort, order);
        return ResponseUtil.okList(brandList);
    }

    private Object validate(IotBrand brand) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody IotBrand brand) {
    ...
    public Object read(@NotNull Integer id) {
        IotBrand brand = brandService.findById(id);
        return ResponseUtil.ok(brand);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody IotBrand brand) {
        Object error = validate(brand);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody IotBrand brand) {
