...
public class AdminTopicController {
    ...
    public Object list(String title, String subtitle,
        ...
        List<IotTopic> topicList = topicService.querySelective(title, subtitle, page, limit, sort, order);
        return ResponseUtil.okList(topicList);
    }

    private Object validate(IotTopic topic) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody IotTopic topic) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody IotTopic topic) {
        Object error = validate(topic);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody IotTopic topic) {
