...
import com.yunqiic.iot.core.storage.QiniuStorage;
...
public class QiniuStorageTest {
    ...
    public void test() throws IOException {
        ...
        qiniuStorage.store(new FileInputStream(test), testFile.length(), "image/png", "iot.png");
        Resource resource = qiniuStorage.loadAsResource("iot.png");
        String url = qiniuStorage.generateUrl("iot.png");
