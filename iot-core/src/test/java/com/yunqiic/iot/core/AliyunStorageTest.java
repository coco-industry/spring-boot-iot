...
import com.yunqiic.iot.core.storage.AliyunStorage;
...
public class AliyunStorageTest {
    ...
    public void test() throws IOException {
        ...
        aliyunStorage.store(new FileInputStream(test), testFile.length(), "image/png", "iot.png");
        Resource resource = aliyunStorage.loadAsResource("iot.png");
        String url = aliyunStorage.generateUrl("iot.png");
