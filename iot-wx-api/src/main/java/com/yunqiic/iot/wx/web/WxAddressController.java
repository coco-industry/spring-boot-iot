...
import com.yunqiic.iot.wx.service.GetRegionService;
...
public class WxAddressController extends GetRegionService {
	...
	public Object list(@LoginUser Integer userId) {
		...
		List<IotAddress> addressList = addressService.queryByUid(userId);
	...
	public Object detail(@LoginUser Integer userId, @NotNull Integer id) {
		...
		IotAddress address = addressService.query(userId, id);
		if (address == null) {
	...
	private Object validate(IotAddress address) {
	 ...
	 */
	@PostMapping("save")
	public Object save(@LoginUser Integer userId, @RequestBody IotAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
		...
		if (address.getId() == null || address.getId().equals(0)) {
			...
			IotAddress iotAddress = addressService.query(userId, address.getId());
			if (iotAddress == null) {
				return ResponseUtil.badArgumentValue();
			}
	 ...
	 */
	@PostMapping("delete")
	public Object delete(@LoginUser Integer userId, @RequestBody IotAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
		...
		IotAddress iotAddress = addressService.query(userId, id);
		if (iotAddress == null) {
			return ResponseUtil.badArgumentValue();
		}
