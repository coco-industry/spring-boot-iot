...
import com.yunqiic.iot.core.util.bcrypt.BCryptPasswordEncoder;
import com.yunqiic.iot.db.domain.IotUser;
import com.yunqiic.iot.db.service.CouponAssignService;
...
import com.yunqiic.iot.wx.dto.WxLoginInfo;
import com.yunqiic.iot.wx.service.CaptchaCodeManager;
...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        List<IotUser> userList = userService.queryByUsername(username);
        IotUser user = null;
        if (userList.size() > 1) {
    ...
    public Object loginByWeixin(@RequestBody WxLoginInfo wxLoginInfo, HttpServletRequest request) {
        ...
        IotUser user = userService.queryByOid(openId);
        if (user == null) {
            user = new IotUser();
    ...
    public Object register(@RequestBody String body, HttpServletRequest request) {
        ...
        if(!StringUtils.isEmpty(wxCode)) {
            ...
            if (userList.size() == 1) {
                IotUser checkUser = userList.get(0);
    ...
    public Object reset(@RequestBody String body, HttpServletRequest request) {
        ...
        List<IotUser> userList = userService.queryByMobile(mobile);
        IotUser user = null;
        if (userList.size() > 1) {
            return ResponseUtil.serious();
        } else if (userList.size() == 0) {
